...
INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_date, transaction_summary, transaction_type,transaction_amt, 
closing_balance, create_date)  VALUES (UUID(), 1865764, 1, CURDATE()-6, 'Uber', 'Withdrawal', 100,34400,CURDATE()-6);

INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_date, transaction_summary, transaction_type,transaction_amt, 
closing_balance, create_date)  VALUES (UUID(), 1865764, 1, CURDATE()-5, 'Self Deposit', 'Deposit', 500,34900,CURDATE()-5);

INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_date, transaction_summary, transaction_type,transaction_amt, 
closing_balance, create_date)  VALUES (UUID(), 1865764, 1, CURDATE()-4, 'Ebay', 'Withdrawal', 600,34300,CURDATE()-4);

INSERT INTO account_transactions (transaction_id, account_number, customer_id, transaction_date, transaction_summary, transaction_type,transaction_amt, 
closing_balance, create_date)  VALUES (UUID(), 1865764, 1, CURDATE()-2, 'OnlineTransfer', 'Deposit', 700,35000,CURDATE()-2);
